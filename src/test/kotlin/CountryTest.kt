...
class CountryTest{
    ...
    val saxonCountry = Country("Kent", listOf("MaleName"), listOf("FemaleName"), listOf("Surname"), listOf("Language"))
    val forenameCountry = Country("Franks", listOf("MaleName"), listOf("FemaleName"), listOf("Surname"), listOf("Language"))
